...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative"
      style={{ maxWidth: "80%", paddingTop: "80px", margin: "0 auto" }}
    >
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-2/5 px-6">
              ...
              <p className="mt-1">Seattle, WA 98109</p>
            </div>
            <div className="lg:w-3/5 px-6 mt-4 lg:mt-0">
              ...
              <a
                ...
                href="mailto:vishnusaibhosekar@gmail.com"
              >
                vishnusaibhosekar@gmail.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">201-238-3902</p>
            </div>
          </div>
        </div>
        <form
        ...
        >
          ...
          <p className="leading-relaxed mb-5">
            Drop your name and email if you'd like to get in touch with me :)
          </p>
