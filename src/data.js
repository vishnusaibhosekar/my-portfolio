...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A notes app to save notes, make to-do lists. User has to login using a Google Account.",
  ...
  },
  {
    ...
    description:
      "A chatting application where multiple users can chat in a chatroom. There is not limit to how many users can join.",
    image: "./ChatRoom.png",
  ...
  },
  {
    ...
    description:
      "A website to buy and sell products. Users can add products to cart, checkout and pay. Admins can add, edit and delete products.",
    image: "./Shop.jpeg",
